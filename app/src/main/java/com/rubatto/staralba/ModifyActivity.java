...
public class ModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int businessSeq = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).BUSINESS_SEQ;
        String businessName = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).BUSINESS_NAME;
        String title = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).TITLE;
        String name = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).BUSINESS_USER;
        String phone = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).BUSINESS_PHONE;
        String category = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).CATEGORY_SE_NM;
        String paySeCd = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).PAY_SE_CD;
        int pay = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).PAY;
        String realPay = "";
        if (paySeCd.equals("0")) {
            paySeCd = "협의";
            realPay = "0";
        ...
        String address = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).ADDRESS;
        ArrayList<String> theme = new ArrayList<>();
        theme = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).THEME_LIST;
        ArrayList<String> guarantee = new ArrayList<>();
        guarantee = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).GUARANTEE_LIST;
        String content = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).CONTENT;
        mLat = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).LAT;
        mLng = DataMyBusinessInfo.getMyBusinessInfoData().get(Integer.parseInt(position)).LNG;

        //mBackImg = (ImageView) findViewById(R.id.register_backbutton);
        mBusinessNameEd = (EditText) findViewById(R.id.modify_business_name_ed);
        mProfileImg = (ImageView) findViewById(R.id.modify_profile_img);
        mProfileTv = (TextView) findViewById(R.id.modify_profile_tv);
        mTitleEd = (EditText) findViewById(R.id.modify_title_ed);
        mNameEd = (EditText) findViewById(R.id.modify_name_edit);
        mPhoneEd = (EditText) findViewById(R.id.modify_phone_edit);
        mCategoryTv = (TextView) findViewById(R.id.modify_category_tv);
        mPayLayout = (LinearLayout) findViewById(R.id.modify_pay_layout);
        mPaySeTv = (TextView) findViewById(R.id.modify_pay_se_tv);
        mPayTv = (TextView) findViewById(R.id.modify_pay_tv);
        mAddressLayout = (LinearLayout) findViewById(R.id.modify_address_layout);
        mAddressTv = (TextView) findViewById(R.id.modify_address_tv);
        mThemeLayout = (LinearLayout) findViewById(R.id.modify_theme_layout);
        mThemeTv = (TextView) findViewById(R.id.modify_theme_tv);
        mGuaranteeLayout = (LinearLayout) findViewById(R.id.modify_guarantee_layout);
        mGuaranteeTv = (TextView) findViewById(R.id.modify_gurantee_tv);
        mIntroduceEd = (EditText) findViewById(R.id.modify_introduce_ed);
        mRegisterBt = (Button) findViewById(R.id.modify_bt);

        mBusinessNameEd.setText(businessName);
        mProfileTv.setText(businessName);
        mTitleEd.setText(title);
        mNameEd.setText(name);
        mPhoneEd.setText(phone);
        ...
        mProfileImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ModifyActivity.this, "프로필 이미지 선택", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mCategoryTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder buider = new AlertDialog.Builder(ModifyActivity.this); //AlertDialog.Builder 객체 생성
                ...
                confirmBt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (id == -1) {
                            Toast.makeText(ModifyActivity.this, "업종을 선택해 주세요", Toast.LENGTH_SHORT).show();
                        } else {
            ...
            public void onClick(final View view) {
                ...
                confirmBt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (id == -1) {
                            Toast.makeText(ModifyActivity.this, "급여를 선택해 주세요", Toast.LENGTH_SHORT).show();
                        } else if (payRadioBt.isChecked()) {

                            if (payEd.getText().toString().isEmpty()) {
                                Toast.makeText(ModifyActivity.this, "시급을 입력해 주세요", Toast.LENGTH_SHORT).show();
                            } else {
        ...
        mAddressLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder buider = new AlertDialog.Builder(ModifyActivity.this); //AlertDialog.Builder 객체 생성
                ...
                confirmBt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        mGeocoder = new Geocoder(ModifyActivity.this);
                        List<Address> list = null;

                        String address = addressEd.getText().toString();

                        if (address.isEmpty()) {
                            Toast.makeText(ModifyActivity.this, "주소를 입력해 주세요", Toast.LENGTH_SHORT).show();
                        } else {
                            try {
                            ...
                            if (list != null) {
                                if (list.size() == 0) {
                                    Toast.makeText(ModifyActivity.this, "주소를 확인해 주세요", Toast.LENGTH_SHORT).show();
                                } else {
                                    ...
                                    Toast.makeText(ModifyActivity.this, String.valueOf(mLat) + "/" + String.valueOf(mLng), Toast.LENGTH_SHORT).show();
        ...
        mThemeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /*plusBt.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        EditText editText = new EditText(ModifyActivity.this);
                ...
                confirmBt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (count == 0) {
                            Toast.makeText(ModifyActivity.this, "관심테마를 선택해 주세요", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            for (int i = 0; i < row; i++) {
                                LinearLayout layout = new LinearLayout(ModifyActivity.this);
            ...
            public void onClick(View view) {
                ...
                confirmBt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (mGuaranteeResult.isEmpty()) {
                            Toast.makeText(ModifyActivity.this, "보장정보를 선택해 주세요", Toast.LENGTH_SHORT).show();
                        } else {
                            TextView tv = new TextView(ModifyActivity.this);
        ...
        mRegisterBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!(null == mGuaranteeResult || "".equals(mGuaranteeResult))) {
                    ...
                    guarantee = mGuarantee;
                }
                String introduce = mIntroduceEd.getText().toString();

                if (businessName.isEmpty() || businessName.equals("")) {
                    Toast.makeText(ModifyActivity.this, "업체명을 입력해 주세요", Toast.LENGTH_SHORT).show();
                } else if (title.isEmpty() || title.equals("")) {
                    Toast.makeText(ModifyActivity.this, "제목을 입력해 주세요", Toast.LENGTH_SHORT).show();
                } else if (name.isEmpty() || name.equals("")) {
                    Toast.makeText(ModifyActivity.this, "실명/직급을 입력해 주세요", Toast.LENGTH_SHORT).show();
                } else if (phone.isEmpty() || phone.equals("")) {
                    Toast.makeText(ModifyActivity.this, "전화번호를 입력해 주세요", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ModifyActivity.this, "소개를 입력해 주세요", Toast.LENGTH_SHORT).show();
                } else {
                    String myNumber = "01041844910";
                    postData(String.valueOf(businessSeq), myNumber, businessName, title, name, phone, category_se_cd, pay_se_cd, realPay, address, theme, guarantee, introduce, lat, lng);
                }
            }
        });
    }
    ...
    private void postData(String businessSeq, String myNumber, String businessName, String title, String name, String phone, String category_se_cd, String pay_se_cd,
        ...
        try {
            result = mDataTask.execute(businessSeq, myNumber, businessName, title, name, phone, category_se_cd, pay_se_cd, realPay, address, theme, guarantee, introduce, lon, lng).get();
    ...
    private class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                String urlString = "http://staralba3336.cafe24.com/star/mobile/updateBusinessInfo.do";
                ...
                String business_name = strings[2];
                String title = strings[3];
                String name = strings[4];
                String business_phone = strings[5];
                String category_se_cd = strings[6];
                String pay_se_cd = strings[7];
                String real_pay = strings[8];
                String address = strings[9];
                String theme = strings[10];
                String guarantee = strings[11];
                String introduce = strings[12];
                String lat = strings[13];
                String lng = strings[14];
                sendMsg = "BUSINESS_SEQ=" + business_seq + "&PHONE=" + phone + "&BUSINESS_NAME=" + business_name + "&TITLE=" + title + "&BUSINESS_USER=" + name
